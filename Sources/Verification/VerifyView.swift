                ...
                VStack(spacing: 12) {
                    ...
                    Button {
                        ...
                        HStack {
                            ...
                            Text(selectedImageData != nil ? L10n.Verify.verifyWithImage : L10n.Verify.verifyWithoutImage)
                        }
                        .font(.headline)
                        .foregroundColor(.white)
                        .frame(maxWidth: .infinity)
                    ...
                    if selectedImageData == nil {
                        Button {
                            onSkip()
                            // dismiss()は親のonSkipコールバック内で処理される
                        } label: {
                            Text(L10n.Verify.skipImageVerification)
                                .font(.subheadline)
                                .foregroundColor(.secondary)
                        }
                    }
