...
final class AppState: ObservableObject {
    ...
    func initialize() async {
        do {
            ...
            isInitialized = true
            print("[VeriCapture] Initialization complete. ChainID: \(chainId ?? "unknown")")
            ...
            print("[VeriCapture] Initialization failed: \(error)")
        }
    }
    ...
    private func warmupSecureEnclave() async {
        ...
        print("[VeriCapture] Crypto warmup complete")
    }
}
