...
enum L10n {
    ...
    // Video Recording
    enum Video {
        static let modePhoto = "video.mode.photo".localized
        static let modeVideo = "video.mode.video".localized
        static let recording = "video.recording".localized
        static let tapToRecord = "video.tap_to_record".localized
        static let tapToStop = "video.tap_to_stop".localized
        static let processing = "video.processing".localized
        static let hashingProgress = "video.hashing_progress".localized
        static let duration = "video.duration".localized
        static let resolution = "video.resolution".localized
        static let maxDuration = "video.max_duration".localized
        static let saved = "video.saved".localized
        static let cancelled = "video.cancelled".localized
    }
    ...
    enum Share {
        ...
        static let videoOnly = "share.video_only".localized
        static let videoOnlyDesc = "share.video_only.desc".localized
        static let videoWarningDesc = "share.video_warning.desc".localized
        ...
        // C2PA
        static let includeC2PA = "share.include_c2pa".localized
        static let includeC2PADesc = "share.include_c2pa_desc".localized
        // Raw Data Export
        ...
        // v42: Simplified share options
        static let exportZip = "share.export_zip".localized
        static let exportZipDesc = "share.export_zip_desc".localized
        static let c2paExport = "share.c2pa_export".localized
        static let c2paExportDesc = "share.c2pa_export_desc".localized
        static let verificationBadge = "share.verification_badge".localized
        static let proofLostWarning = "share.proof_lost_warning".localized
        // v42: QR Preview
        static let qrPreviewTitle = "share.qr_preview_title".localized
        static let qrAddedExplanation = "share.qr_added_explanation".localized
        static let qrScanInstruction = "share.qr_scan_instruction".localized
        static let shareWithQR = "share.share_with_qr".localized
        static let generatingQR = "share.generating_qr".localized
    }
    ...
    enum Verify {
        ...
        static let mediaType = "verify.media_type".localized
        static let mediaTypeImage = "verify.media_type_image".localized
        static let mediaTypeVideo = "verify.media_type_video".localized
        ...
        static let signerProtected = "verify.signer_protected".localized
        static let signerNotProtected = "verify.signer_not_protected".localized
        static let attestedBadge = "verify.attested_badge".localized
        static let verifiedByVeraSnap = "verify.verified_by_verasnap".localized
        static let slogan = "verify.slogan".localized
        ...
        static let resultAuthenticVideoMessage = "verify.result.authentic_video_message".localized
        ...
        static let tamperWarning = "verify.tamper_warning".localized
        // Check names
        ...
        static let checkVideoHashName = "verify.check.video_hash".localized
        // Check steps
        ...
        static let checkVideoNotProvided = "verify.check.video_not_provided".localized
        ...
        static let verifyWithVideo = "verify.verify_with_video".localized
        static let verifyWithoutImage = "verify.verify_without_image".localized
        static let verifyProofOnly = "verify.verify_proof_only".localized
        static let verifyProofOnlyVideo = "verify.verify_proof_only_video".localized
        static let skipImageVerification = "verify.skip_image_verification".localized
        static let skipVideoVerification = "verify.skip_video_verification".localized
        static let imageVerificationNote = "verify.image_verification_note".localized
        static let videoVerificationNote = "verify.video_verification_note".localized
        static let assetHashVerification = "verify.asset_hash_verification".localized
        
        // Media Verification (v42 - Video Support)
        static let mediaVerificationTitle = "verify.media_verification_title".localized
        static let mediaVerificationDesc = "verify.media_verification_desc".localized
        static let selectMediaTitle = "verify.select_media_title".localized
        static let selectMediaFromFiles = "verify.select_media_from_files".localized
        static let mediaSelected = "verify.media_selected".localized
        static let changeMedia = "verify.change_media".localized
        static let skipMediaVerification = "verify.skip_media_verification".localized
        static let skipMediaVerificationDesc = "verify.skip_media_verification_desc".localized
    }
    ...
    enum Settings {
        ...
        static let openSourceMessage = "settings.open_source_message".localized
        static let viewOnGitHub = "settings.view_on_github".localized
        // Plan section
        ...
        static let exportAllForensicDescWithMedia = "settings.export_all_forensic_desc_with_media".localized
        static let exportAllForensicFooter = "settings.export_all_forensic_footer".localized
        static let exportIncludeMedia = "settings.export_include_media".localized
        static let exportIncludeMediaDesc = "settings.export_include_media_desc".localized
        static let exportIncludeC2PA = "settings.export_include_c2pa".localized
        static let exportIncludeC2PADesc = "settings.export_include_c2pa_desc".localized
        static let c2paMappingTitle = "settings.c2pa_mapping_title".localized
        static let c2paMappingHeader = "settings.c2pa_mapping_header".localized
        static let c2paMappingDesc = "settings.c2pa_mapping_desc".localized
        // Export alert
    ...
    // TSA Settings
    enum TSASettings {
        static let configuredProviders = "tsa_settings.configured_providers".localized
        static let reorderHint = "tsa_settings.reorder_hint".localized
        static let addProvider = "tsa_settings.add_provider".localized
        static let providerName = "tsa_settings.provider_name".localized
        static let region = "tsa_settings.region".localized
        static let customProviderHint = "tsa_settings.custom_provider_hint".localized
        static let cancel = "tsa_settings.cancel".localized
        static let add = "tsa_settings.add".localized
    }
    ...
    // C2PA Info
    enum C2PAInfo {
        static let title = "c2pa_info.title".localized
        static let whatIsC2PA = "c2pa_info.what_is_c2pa".localized
        static let whatIsC2PADesc = "c2pa_info.what_is_c2pa_desc".localized
        static let howToUse = "c2pa_info.how_to_use".localized
        static let howToUseDesc = "c2pa_info.how_to_use_desc".localized
        static let learnMore = "c2pa_info.learn_more".localized
    }
    ...
    enum Permission {
        ...
        static let allowCamera = "permission.allow_camera".localized  // Deprecated
        static let continueButton = "permission.continue_button".localized  // Apple Guideline 5.1.1
    ...
    enum Subscription {
        ...
        static let signInRequired = "subscription.sign_in_required".localized
        static let verificationFailed = "subscription.verification_failed".localized
        static let purchaseFailed = "subscription.purchase_failed".localized
    ...
    enum TSA {
        ...
        static let endpointUrl = "tsa.endpoint_url".localized
    }
    ...
    enum Conformance {
        // Level names
        static let bronze = "conformance.bronze".localized
        static let silver = "conformance.silver".localized
        static let gold = "conformance.gold".localized
        
        // Descriptions
        static let bronzeDesc = "conformance.bronze_desc".localized
        static let silverDesc = "conformance.silver_desc".localized
        static let goldDesc = "conformance.gold_desc".localized
        
        // Proof strength
        static let strengthLow = "conformance.strength_low".localized
        static let strengthMedium = "conformance.strength_medium".localized
        static let strengthHigh = "conformance.strength_high".localized
        
        // UI labels
        static let proofLevel = "conformance.proof_level".localized
        static let whatIsThis = "conformance.what_is_this".localized
    }
}
