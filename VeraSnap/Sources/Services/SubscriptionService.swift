...
final class SubscriptionService: ObservableObject {
    ...
    private init() {
        ...
        // 製品ロードはさらに遅延（VeraSnapApp.swiftで明示的に呼ばれる）
    }
    ...
    func restorePurchases() async -> Bool {
        ...
        do {
            ...
            errorMessage = L10n.Subscription.signInRequired
            print("[SubscriptionService] No App Store account signed in")
            return false
        } catch {
            errorMessage = L10n.Subscription.restoreFailed
...
enum SubscriptionError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .verificationFailed: return L10n.Subscription.verificationFailed
        case .purchaseFailed: return L10n.Subscription.purchaseFailed
        case .restoreFailed: return L10n.Subscription.restoreFailed
        }
    }
}
